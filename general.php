<!DOCTYPE html>
  ...
  <nav>
    ...
    <div class="container">
  <center> 
    <i><font color="white"><h1>Compras</h1></font></i>
<table class="striped"> 
...
FROM 
    usuarios u
LEFT JOIN 
    comp2 comp ON u.idcliente = comp.idcliente
LEFT JOIN 
    comentario cc ON comp.idarticulo = cc.idarticulo
LEFT JOIN 
    datos da ON cc.telefono = da.telefono
ORDER BY 
    u.idcliente, comp.idarticulo, da.fecha";
