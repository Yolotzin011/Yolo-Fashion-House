  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        <div class="card-image">
                            <img src="dress3.jpg" alt="Vestido Elegante" id="product-image">
                        </div>
                        <div class="card-content">
                            <h5 class="card-title">Vestido Elegante-De noche</h5>
                            <p>Este vestido es una exquisita creación en tono plateado, ideal para eventos formales y elegantes. Con un diseño asimétrico de un solo hombro, destaca por su tejido brillante que añade un toque de glamour. El drapeado en el busto y la cintura resalta la figura, mientras que la abertura alta en la pierna aporta un toque atrevido y sensual. El lazo en la cintura agrega un detalle sofisticado, completando un look espectacular y chic.</p>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="458440">
