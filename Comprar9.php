  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        <div class="card-image">
                            <img src="dress9.jpg" alt="Vestido Elegante" id="product-image">
                        </div>
                        <div class="card-content">
                            <h5 class="card-title">Vestido Elegante-Formal</h5>
                            <p>Este vestido es una creación elegante y majestuosa, ideal para eventos formales. De color rojo oscuro con detalles en negro, presenta un escote tipo barco que deja los hombros al descubierto, añadiendo un toque romántico y sofisticado. El corpiño ajustado realza la figura, mientras que la falda amplia y fluida cae en pliegues suaves, creando un efecto dramático y refinado. El tejido tiene un ligero brillo, aportando un aire de lujo y distinción al conjunto.</p>
                            </div>
                    </div>
                </div>
            </div>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="529255">
          ...
          <label>Categoria</label>
                ...
                <div class="input-field">
          <input id="precio" name="Preciotxt" REQUIRED type="text" class="validate" value="$10900.00">
          <label>Precio</label>
        </div>
        <div class="input-field">
          <input id="idCliente" name="Clientetxt" REQUIRED type="text" class="validate">
          <label>idCliente</label>
        </divEste vestido es una creación elegante y majestuosa, ideal para eventos formales. De color rojo oscuro con detalles en negro, presenta un escote tipo barco que deja los hombros al descubierto, añadiendo un toque romántico y sofisticado. El corpiño ajustado realza la figura, mientras que la falda amplia y fluida cae en pliegues suaves, creando un efecto dramático y refinado. El tejido tiene un ligero brillo, aportando un aire de lujo y distinción al conjunto.
        <div class="input-field">
