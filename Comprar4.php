  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        <div class="card-image">
                            <img src="dress4.jpg" alt="Vestido Elegante" id="product-image">
                        </div>
                        <div class="card-content">
                            <h5 class="card-title">Vestido Elegante-De noche</h5>
                            <p>El vestido en la imagen es un elegante vestido de noche de color rojo brillante. Está diseñado con un corte ceñido al cuerpo que resalta la figura, y cuenta con un escote palabra de honor que deja los hombros al descubierto. Una de las características más llamativas es su abertura alta en la pierna izquierda, que aporta un toque de sensualidad y sofisticación. El tejido parece estar cubierto de lentejuelas o pedrería, lo que le da un brillo y destello especial bajo la luz. El vestido también tiene una cola que se extiende ligeramente hacia atrás, añadiendo un toque de glamour adicional.</p>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="277555">
          <label>id Articulo</label>
        </div>
                <div class="input-field">
          <input id="categoria" name="Categoriatxt" REQUIRED type="text" class="validate" value="Vestido Elegante-De noche">
          <label>Categoria</label>
        </div>
                <div class="input-field">
          <input id="precio" name="Preciotxt" REQUIRED type="text" class="validate" value="$7900.00">
          <label>Precio</label>
        </div>
        <div class="input-field">
