  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        <div class="card-image">
                            <img src="dress8.jpg" alt="Vestido Elegante" id="product-image">
                        </div>
                        <div class="card-content">
                            <h5 class="card-title">Vestido Elegante-De noche</h5>
                            <p>Este es un vestido elegante y sofisticado de color negro. Tiene un diseño ajustado que resalta la figura, con detalles de pedrería brillante en la parte delantera y laterales que le dan un toque de glamour. La parte superior del vestido tiene un escote asimétrico con tirantes cruzados que agregan un elemento de interés visual. La falda se extiende en una cola larga y fluida, haciendo de este vestido una opción ideal para eventos formales y alfombras rojas.</p>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="234122">
          <label>id Articulo</label>
        </div>
                <div class="input-field">
          <input id="categoria" name="Categoriatxt" REQUIRED type="text" class="validate" value="Vestido Elegante-Alfombra">
          <label>Categoria</label>
        </div>
                <div class="input-field">
          <input id="precio" name="Preciotxt" REQUIRED type="text" class="validate" value="$14900.00">
          <label>Precio</label>
        </div>
        <div class="input-field">
