  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        <div class="card-image">
                            <img src="dress6.jpg" alt="Vestido Elegante" id="product-image">
                        </div>
                        <div class="card-content">
                            <h5 class="card-title">Vestido Elegante-De gala</h5>
                            <p>Este deslumbrante vestido azul marino cuenta con un corsé palabra de honor adornado con intrincados apliques florales blancos. La falda, hecha de capas de tul, cae en una hermosa forma de A, creando un efecto de volumen etéreo y elegante. Ideal para ocasiones formales o eventos de gala, este vestido combina la delicadeza del encaje con la sofisticación del tul para un look romántico y majestuoso.</p>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="462662">
          <label>id Articulo</label>
        </div>
                <div class="input-field">
          <input id="categoria" name="Categoriatxt" REQUIRED type="text" class="validate" value="Vestido Elegante-De gala">
          <label>Categoria</label>
        </div>
                <div class="input-field">
          <input id="precio" name="Preciotxt" REQUIRED type="text" class="validate" value="$8500.00">
          <label>Precio</label>
        </div>
        <div class="input-field">
