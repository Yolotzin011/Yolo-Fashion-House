<!DOCTYPE html>
  ...
  <nav>
    ...
    <div class="container">
  <center> 
    <i><font color="white"><h1>Pedidos</h1></font></i>
<table class="striped"> 
  ...
  <?php
  include("ConeC.php");
  $query="SELECT comp2.nombre,comp2.categoria,datos.fecha FROM comp2 RIGHT JOIN datos ON comp2.idcliente=datos.idcliente";
