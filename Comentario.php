...
<section id="contacto" class="section">
    <div class="container">
      ...
      <form class="col s12"  action = "comentarioBD.php" method="POST" enctype="multipart/form-data">
        <div class="input-field">
          <input id="idComet" name="idComentxt" REQUIRED type="text" class="validate" placeholder="Genera un id de tu comentario">
        ...
        <div class="input-field">
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate">
        ...
        <div class="input-field">
         ...
         <div class="input-field">
          <input id="coment" name="Comentariotxt" REQUIRED type="text" class="validate">
