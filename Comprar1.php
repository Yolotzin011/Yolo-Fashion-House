  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        ...
                        <div class="card-content">
                            ...
                            <p>El vestido es un elegante diseño de gala en color negro, con un corte largo que se extiende hasta el suelo. Presenta un escote corazón y mangas caídas, añadiendo un toque romántico y sofisticado. La falda está confeccionada con varias capas de tul, dándole volumen y movimiento. Un detalle notable es la abertura alta en la parte frontal de la falda, que aporta un aire de sensualidad y modernidad. Completa el look con unos zapatos de tacón alto decorados con brillantes. Este vestido es ideal para eventos formales y noches especiales.</p>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="483765">
          ...
          <label>Categoria</label>
                ...
                <div class="input-field">
          <input id="precio" name="Preciotxt" REQUIRED type="text" class="validate" value="$9500.00">
          <label>Precio</label>
        </div>
          <div class="input-field">
