  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        <div class="card-image">
                            <img src="dress5.jpg" alt="Vestido Elegante" id="product-image">
                        </div>
                        <div class="card-content">
                            <h5 class="card-title">Vestido Elegante-Formal</h5>
                            <p>Este elegante vestido verde presenta un diseño asimétrico de un solo hombro adornado con detalles brillantes en el busto y la cintura. La parte superior se ajusta al cuerpo, mientras que la falda voluminosa y abierta añade un toque dramático y sofisticado. Perfecto para eventos formales, este vestido combina modernidad y elegancia con un acabado satinado que captura la luz de manera hermosa.</p>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="414617">
          ...
          <label>Categoria</label>
                ...
                <div class="input-field">
          <input id="precio" name="Preciotxt" REQUIRED type="text" class="validate" value="$15500.00">
          <label>Precio</label>
        </div>
        <div class="input-field">
