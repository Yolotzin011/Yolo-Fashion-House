  ...
  <nav>
    ...
    <section id="Comprar" class="section">
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <div class="card product-detail-card">
                        <div class="card-image">
                            <img src="dress2.jpg" alt="Vestido Elegante" id="product-image">
                        </div>
                        <div class="card-content">
                            <h5 class="card-title">Vestido Elegante-Formal</h5>
                            <p>Este vestido es una elegante prenda de gala, confeccionada en terciopelo azul profundo. Presenta un diseño asimétrico de un solo hombro, acentuado por un drapeado en la cintura que añade un toque sofisticado. La falda larga incluye una abertura alta en la pierna, que añade un elemento seductor y moderno. Este vestido es perfecto para eventos formales donde se desee destacar con estilo y elegancia.</p>
          ...
          <input id="idA" name="Articulotxt" REQUIRED type="text" class="validate" value="192607">
        ...
        <div class="input-field">
          ...
          <label>Categoria</label>
                ...
                <div class="input-field">
          <input id="precio" name="Preciotxt" REQUIRED type="text" class="validate" value="$10,000.00">
          <label>Precio</label>
        </div>
        <div class="input-field">
